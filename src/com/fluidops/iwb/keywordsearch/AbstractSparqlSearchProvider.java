...
public abstract class AbstractSparqlSearchProvider implements
	...
	protected String instantiateKeywordQuery(String keywordString, String querySkeleton) throws Exception {
		String luceneQuery = null;
		luceneQuery = KeywordSearchAPI.normalizeLuceneQuery(keywordString);
		luceneQuery = StringUtil.escapeUnsupportedLuceneCharacters(luceneQuery);
		luceneQuery = StringUtil.escapeSparqlStrings(luceneQuery);
		
		return querySkeleton.replace("??", luceneQuery);
		
	}
	
	protected TupleQueryResult searchUsingKeywordQuerySkeleton(String keywordString, String querySkeleton) throws Exception
	{
		String sparqlQuery = instantiateKeywordQuery(keywordString, querySkeleton);
