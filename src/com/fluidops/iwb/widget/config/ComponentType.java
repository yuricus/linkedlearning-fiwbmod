...
public enum ComponentType 
{
	...
	TEXTFIELD {
		@Override
		public FComponent create(final String id, final FEventListener eventListener, final URI valueType)
		{
				return new FValueHoldingTextInput(id, "") {
					
					private URI currentType = valueType;
						
					@Override
					public Object returnValues() {
						return this.getOrCreateRDFValue(currentType, null);
					}
	...
	DROPDOWN {
		...
		public FComponent create(final String id, final FEventListener eventListener, final URI valueType)
		{
			return new FValueDropdown(id, null, false);
		}
	};
	 ...
	 */
	public abstract FComponent create(final String id, final FEventListener eventListener, final URI valueType);
}