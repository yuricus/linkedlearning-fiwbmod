 ...
 * If the parameter link is not set, it works if pc.value represents a link of an accessible site URL
 * @author ango
 */
...
public class LikeWidget extends AbstractWidget<LikeWidget.Config>
{
    ...
    public FComponent getComponent(String id)
    {
        ...
        Config conf = get();
        final String link = (conf!=null && conf.link!=null) ? conf.link : pc.value.stringValue();
        ...
        return new FComponent(id)
        {
            ...
            {  
                ...
                "<iframe src=\"http://www.facebook.com/plugins/like.php?href="+link+"&locale=en_US&layout=standard&show-faces=true&width=500&action=like&colorscheme=light\" "+ 
