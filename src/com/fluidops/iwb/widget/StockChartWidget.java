...
public class StockChartWidget extends AbstractWidget<StockChartWidget.Config>
{
    ...
    public FComponent getComponent(String id)
    {
        ...
        ///////////////////////////////////////////////////// CREATE CHART
        // create basic chart...
        ChartDataModel pm = ChartWidgetUtil.createChartModel(FChartType.STOCK, config.height,
    ...
    public List<String> jsURLs()
    {
        ...
        return Lists.newArrayList(cp + "/amchart/js/amstock/amstock.js", cp + "/amchart/js/amfallback.js");
    }
}
