...
public class SimpleNewInstanceWidget extends AbstractWidget<SimpleNewInstanceWidget.Config>
{
    ...
    public static class Config
    {
    	...
    	@ParameterConfigDoc(
    			...
    			defaultValue = "false")
        public Boolean omitDynamicVerification = false;
    	...
    	@ParameterConfigDoc(
    			desc = "If URI is randomized, this parameter decides about the property " +
    					"to be used as label property for the newly created instance. Default: rdfs:label")
    ...
    {
        Config c = get();
        final Boolean omitDynamicVerification = c.omitDynamicVerification;   
        final Boolean saveCreationDate = c.saveCreationDate;
        final String namespace = c.namespace;
        
        if (c.randomizingType != null && !(c.randomizingType == RandomizingType.UUID || c.randomizingType == RandomizingType.fluidRandom ))
