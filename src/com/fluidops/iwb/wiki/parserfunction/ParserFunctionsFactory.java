...
public class ParserFunctionsFactory {
	...
	/**
	 * Registers the specified {@link PageContextAwareParserFunction} to the wiki
	 * model. Note that this method sets the page context to the function.
	 * 
	 * @param wikiModel
	 * @param pc
	 * @param pf
	 */
	public static void registerParserFunction(FluidWikiModel wikiModel, PageContext pc,
			PageContextAwareParserFunction pf) {
		pf.setPageContext(pc);
		wikiModel.addContextAwareTemplateFunction(pf);
	}
