...
/**
 * A {@link TextInputConfigurationFormElement} to mask passwords 
 * as ***
 * 
 * @author as
 */
public class PasswordSimpleConfigurationFormElement extends TextInputConfigurationFormElement {
	
	@Override
	protected FTextInput2 createComponent(FormElementConfig formElementConfig) {
		FTextInput2 res = super.createComponent(formElementConfig);
		res.setType(ElementType.PASSWORD);
		return res;
	}
}
