...
public class Version
{
	private static Singleton<VersionInfo> versionInfo = new Singleton<VersionInfo>() {
		protected VersionInfo createInstance() throws Exception {
			return VersionInfo.getVersionInfoForClass(Version.class, 
										System.getProperty("product.name", "Information Workbench"), 
										System.getProperty("product.version", "8.8.8.8888"));
		}
	};
