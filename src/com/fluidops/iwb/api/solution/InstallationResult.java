...
public interface InstallationResult extends Serializable
{
    ...
    enum InstallationStatus {
        ...
        /**
         * Installation ended with errors, but the restart is still required.
         * This is needed to resolve errors caused by the code dependencies, which can only be done 
         * after new start.   
         */
        INSTALLED_PARTIALLY_WITH_ERRORS_RESTART_REQUIRED(false, true);
