...
{    
     ...
     * to the RDF database. Replaces existing ontology
    ...
    /**
     * Validates the ontology defined through the class annotations
     * against the ontology loaded in the RDF database. 
     * 
     * @throws Exception
     */
    @Doc("Validates the ontology")
     ...
     * 
     * @param _objId the URI of the object
     * @param c
     * @param timestamp
     */
