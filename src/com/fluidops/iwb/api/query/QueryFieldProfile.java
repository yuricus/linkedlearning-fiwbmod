...
public class QueryFieldProfile {
	...
	boolean containsOnlyResources = false;
	boolean containsSomeResources = false;
	boolean containsSomeLiterals = false;
	/**
	 * 
	 */
	...
	public void checkValue(Value value) {
		...
		if(value != null) {
			if(value instanceof Resource) {
				containsSomeResources = true;
				containsOnlyResources = !containsSomeLiterals && containsSomeResources;
			} else {
				containsOnlyResources = false;
				containsSomeLiterals = true;
	...
	private void setMaybeNumber(boolean val) {
		if(explicitDatatype==null || explicitDatatype.equals(RDFS.LITERAL)) {
