...
public interface API extends DynamicService, Remote
{
	...
	String load(
            ...
            @Par(name="format", type="string", desc="file format (MIME type of the RDF document or name of a supported RDF type, e.g. RDF/XML, N-Triples, TriG)", isRequired=false) String format,
    ...
    @SubApi( "Data catalog service" )
    public DataCatalogService getDataCatalogService() throws RemoteException;    
