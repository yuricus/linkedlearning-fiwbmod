...
//		sb.append("<li onclick=\"getDomElementById('").append(inputID).append(".input').value='").append(uri.stringValue()).append("';\">");
		
		sb.append("<li onclick=\"catchEventId('"+inputID+"',5,'"+uri.stringValue()+"');getDomElementById('"+sublistId+"').style.display='none';getDomElementById('"+inputID+".input').value='"+uri.stringValue()+"';\">");
