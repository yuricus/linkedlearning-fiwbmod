...
public abstract class AbstractXMLFlexProvider extends AbstractFlexProvider<AbstractXMLFlexProvider.Config>
{
     ...
     */
    transient Map<Element, String> node2resource = new HashMap<Element, String>();

    /**
     * elements to skip during processing (e.g. extra array containers)
     */
    transient List<Element> skipNodes = new ArrayList<Element>();
    
    /**
     * result statemets
     */
    transient List<Statement> res;
