 ...
 * variable. If the query is static (not dependent on the user input), 
 * it is evaluated only once, and the results are cached. 
 * 
 * @author andreas_s
 *
 */
